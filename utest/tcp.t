...
MSC1,MME1,interface,name="sgs",port=29118,stack="tcp/sgsap",CS="S"
MME1,MSC1,interface,name="sgs",port=29119,stack="tcp/sgsap"
...
MME1,MSC1,SGsAP-RESET-ACK,MME name="MME1",VLR name="VLR1"
check,debug,sys.log
...
case,4,mosms
MME1,MSC1,SGsAP-UPLINK-UNITDATA,IMSI=0x1234567890123456, NAS message container=1234567890
MSC1,MME1,SGsAP-DOWNLINK-UNITDATA,IMSI=0x1234567890123456, NAS message container=1234567890
check,thomas,/var/log/syslog

procedure, myproc1
mme1,msc1,SGsAP-UPLINK-UNITDATA,NAS message container=1234567890, IMSI=0x1234567890123456
msc1,mme1,SGsAP-DOWNLINK-UNITDATA,IMSI=0x1234567890123456,NAS message container=1234567890
...
case,6,mtsms
MME1,MSC1,SGsAP-UPLINK-UNITDATA,IMSI=0x1234567890123456, NAS message container=0x1234567890
MSC1,MME1,SGsAP-DOWNLINK-UNITDATA,IMSI=0x1234567890123456, NAS message container=0x1234567890
run, ls -l
